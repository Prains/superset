...
export function SuggestionPopover({
	...
	return (
		<div
			role="listbox"
			className="absolute bottom-full left-0 z-50 mb-2 max-h-72 w-80 overflow-y-auto rounded-xl bg-popover/95 p-1 shadow-xl ring-1 ring-border backdrop-blur-sm"
		>
