...
- **This device**: workspaces on the machine you're using now (default)
- **Other devices**: each remote host that has opted in, listed individually with an online indicator

The workspace list always reads from exactly one selected host — there's no merged "all devices" view.
