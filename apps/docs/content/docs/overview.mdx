...
Superset is an open source platform for running AI coding agents in parallel. It's available as a desktop IDE, a command-line interface, and an MCP server.
