...
Right-click a workspace in the sidebar and choose **Pin** to keep it in a **Pinned** section at the top of the sidebar, above all projects. Pins persist across restarts and show a small project avatar for context. **Unpin** returns the workspace to its original project and position. In the collapsed sidebar, pinned workspaces render as an icon stack above the project thumbnails.
