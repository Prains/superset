...
export function DownloadButton({
	...
	const buttonClasses = `bg-foreground text-background ${sizeClasses} font-normal transition-colors hover:bg-brand hover:text-white flex items-center gap-2 whitespace-nowrap shrink-0 ${className}`;
